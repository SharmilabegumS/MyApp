...
class CustomAdapter2(context: Context,contacts: MutableList<Contacts>,private val titleList: List<String>, private val dataList: HashMap<String, ArrayList<Contacts>>) :  BaseExpandableListAdapter() {
    ...
    override fun getChildView(
        ...
        var bitmap = BitmapFactory.decodeByteArray(contacts[childPosition].picId, 0, contacts[childPosition].picId.size, options)
