...
class ViewEvent(var userId: String="sharmilabegum97@gmail.com")  : AppCompatActivity() {
    ...
    val data: HashMap<String, ArrayList<Contacts>>
        get() {
            val listData = HashMap<String, ArrayList<Contacts>>()
...
titleList.add("Guests")
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            ...
            R.id.action_edit -> {
                ...
                val intent = Intent(this@ViewEvent, Edit_Event::class.java);
    ...
    fun fillFields(eventID: Event){
        ...
        duration.setText("${dsc.getDateToStringConversion(dsc.getDateFromMillis(eventID!!.startDate))} to ${dsc.getDateToStringConversion(dsc.getDateFromMillis(eventID!!.endDate))}")}
