...
class MonthFragment : androidx.fragment.app.Fragment() {
    ...
    override fun onCreateView(
        ...
        var currentDateEvents = ge.getEvent(Date(), dsc, calendar, userName)
        ...
        var currentMonthName = SimpleDateFormat("MMM").format(Date())
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == 1) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                showSnackBar(event!!,"Event updated successfully","View")
    ...
    fun showSnackBar(event:Event,message:String,action:String){
        ...
        mySnackbar.setAction(action, View.OnClickListener {
            if(action.equals("View")) {
                val i = Intent(context, ViewEvent::class.java)
        ...
        mySnackbar.addCallback(object : Snackbar.Callback(){
            override fun onDismissed(snackbar: Snackbar, event:Int) {
                MainActivity().fabLayout.visibility=View.VISIBLE
            }
            override fun onShown(snackbar: Snackbar) {
                MainActivity().fabLayout.visibility=View.INVISIBLE
            }
        })
